 		...
 		(function() {
			...
			*/
			this.distanceToSquared = function(v) {
				...
				/**
				this.setEulerFromRotationMatrix = function ( m, order ) {

					console.error( 'THREE.Vector3: .setEulerFromRotationMatrix() has been removed. Use Euler.setFromRotationMatrix() instead.' );

				}

				this.setEulerFromQuaternion = function ( q, order ) {
				...
				*/
				...
				/**
					@expired
					@method getColumnFromMatrix
					@param index {Int}
					@param matrix {MatrixColumn}
				*/
				this.getColumnFromMatrix = function ( index, matrix ) {
