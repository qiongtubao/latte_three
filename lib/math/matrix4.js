(function(define) {'use strict'
	define("latte_three/math/matrix4", ["require", "exports", "module", "window"],
      ...
      */
      ...
      (function() {
         ...
         */
         ...
         /**
            给xAxis, yAxis, zAxis
            @method extractBasics
            @param xAxis
            @param yAxis
            @param zAxis
         */
         this.extractBasics = function(xAxis, yAxis, zAxis) {
           var te = this.elements;
           xAxis.set(te[0], te[1], te[2]);
           yAxis.set(te[4], te[5], te[6]);
           zAxis.set(te[7], te[8], te[9]);
           return this;
         }
         ...
         */
         ...
         this.makeBasis = function ( xAxis, yAxis, zAxis ) {
      		this.set(
        ...
        */
        ...
        this.makeRotationFromEuler = function ( euler ) {
        ...
        this.makeRotationFromQuaternion = function ( q ) {
        ...
        this.multiplyToArray = function ( a, b, r ) {
        ...
        this.applyToVector3Array = function () {
          ...
          this.getInverse = function ( m, throwOnInvertible ) {
          ...
          this.getMaxScaleOnAxis = function () {
          ...
          this.makeTranslation = function ( x, y, z ) {
          ...
          this.makeRotationAxis = function ( axis, angle ) {
          ...
          this.compose = function ( position, quaternion, scale ) {
        ...
        this.makePerspective = function ( fov, aspect, near, far ) {
      		...
      		var ymax = near * Math.tan( mMath.degToRed( fov * 0.5 ) );
      		var ymin = - ymax;
        ...
        this.makeOrthographic = function ( left, right, top, bottom, near, far ) {
