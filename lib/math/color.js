(function(define) {'use strict'
	define("latte_three/math/color", ["require", "exports", "module", "window"],
 	function(require, exports, module, window) {
 		...
 		*/
 		...
 		(function() {
 			...
 			this.copyGammaToLinear = function(color, gammaFactor) {
 			...
 			this.copyLinearToGamma = function(color, gammaFactor) {
 				if ( gammaFactor === undefined ) gammaFactor = 2.0;
 			...
 			this.convertGammaToLinear = function() {
 			...
 			this.convertLinearToGamma = function () {
			...
			this.addColors = function(color1, color2) {
			...
			this.lerp = function(color, alpha) {
